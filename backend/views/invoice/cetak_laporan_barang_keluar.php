...
<table class="table">
    <!-- <thead> -->
    <tr>
        <th colspan="13" align="center">Laporan Spare Part Keluar Pertanggal : <?= date('d/m/Y', strtotime($tanggal_awal)) ?> s/d <?= date('d/m/Y', strtotime($tanggal_akhir)) ?></th>
    </tr>
    <tr>
        ...
        $filter_tanggal = "";
            if ($tanggal_awal != 0 && $tanggal_akhir != 0) {
                ...
                <tr>
                    ...
                    <td align="right"><?= ribuan($data['setelah_diskon'] )?></td>
                </tr>
 <?php } ?>
    <tr>
        ...
        <td style="text-align: right;"><strong><?= ribuan($totalan_harga_setelah_diskon) ?></strong></td>
    </tr>
</table>
