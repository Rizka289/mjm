...
<table  width="100%" style="font-size: 12px;">
    <tr>
        <th rowspan="7">
            <img class="img" src="images/logo.jpg" style="width: 80px;">
        </th>
...
<table class="table">
    <!-- <thead> -->
    <tr>
        <th colspan="12" align="center">Laporan Spare Part Masuk Pertanggal : <?= date('d/m/Y', strtotime($tanggal_awal)) ?> s/d <?= date('d/m/Y', strtotime($tanggal_akhir)) ?></th>
    </tr>
    <tr>
        ...
        <th style="width: 5%;white-space: nowrap;">Status Pembayaran</th>
    </tr>
    <?php
        $no = 1;
...
<?php } ?>
    <tr>
        ...
        <td style="text-align: right;"><strong><?= ribuan($totalan_harga_spare_part) ?></strong></td>
    </tr>
</table>
